...
$ChaptersByDelivery = @{
    'av1' = @(
        'README.md'
        'docs/1-1-startup-profile.md'
        'docs/1-2-solution-profile.md'
        'docs/1-3-target-segments.md'
        'docs/2-1-competitors.md'
        'docs/2-2-interviews.md'
        'docs/2-3-needfinding.md'
        'docs/2-4-requirements-specification.md'
        'docs/2-5-strategic-level-ddd.md'
        'docs/2-6-tactical-level-ddd.md'
        'docs/closing.md'
    )
    'tb1' = @(
        'README.md'
